        ...
        >
          <CardContent sx={{ padding: "24px" }}>
            ...
            >
              ...
              <Chip
                label={project.collateralVerified ? "Deve sure" : "Unverified"}
                size="small"
                sx={{
          ...
          <CardContent sx={{ padding: "24px" }}>
            ...
            <Box display="flex" flexDirection="column" gap="10px">
              <Box display="flex" justifyContent="space-between">
                <Typography fontSize={13} color={theme.colors.thirdBgColors}>
                  Total Funded
                </Typography>
                <Typography
                  fontSize={13}
  ...
  return (
    ...
    >
      ...
      <Box display="flex" alignItems="center" gap="6px">
        ...
        <Typography fontSize={15} fontWeight={700} color={theme.colors.white}>
          {value}
        </Typography>
      </Box>
    </Box>
