...
export default function InvestorProfileView() {
  ...
  return (
    <div className="flex flex-col min-h-screen pt-[100px] px-5 pb-10 md:pt-5 mx-auto">
      ...
      <Card className="bg-background-secondary rounded-[20px] border-background-third w-full transition-all duration-300 hover:border-primary hover:-translate-y-1 hover:shadow-[0_8px_24px_rgba(44,255,158,0.15)]">
        <CardContent className="px-5 py-[25px] sm:p-[35px]">
