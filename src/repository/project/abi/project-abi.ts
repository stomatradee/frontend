export const PROJECT_NFT_CONTRACT_ADDRESS = (process.env
  .NEXT_PUBLIC_PROJECT_NFT_ADDRESS || "") as `0x${string}`;
...
export const PROJECT_NFT_ABI = [
  ...
  },
  {
    ...
    name: "ProjectNFT__CollectorBlacklisted",
    type: "error",
  },
  { inputs: [], name: "ProjectNFT__InvalidFundingDuration", type: "error" },
  {
    inputs: [
    ...
    name: "ProjectNFT__InvalidStatus",
    type: "error",
  },
  {
    inputs: [{ internalType: "address", name: "caller", type: "address" }],
    name: "ProjectNFT__NotRegisteredCollector",
    type: "error",
  },
  {
    inputs: [{ internalType: "uint256", name: "projectId", type: "uint256" }],
    name: "ProjectNFT__ProjectNotFound",
    type: "error",
  },
  { inputs: [], name: "ProjectNFT__ZeroAddress", type: "error" },
  { inputs: [], name: "ProjectNFT__ZeroValue", type: "error" },
  {
    anonymous: false,
    inputs: [
      {
    ...
    outputs: [
      {
        ...
        internalType: "struct IProjectNFT.ProjectData",
        name: "",
        type: "tuple",
      },
    ],
